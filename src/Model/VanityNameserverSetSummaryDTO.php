...
final readonly class VanityNameserverSetSummaryDTO implements ApiModel
{
     ...
     * @param VanityNameserverSetStatusDTO $status Lifecycle status of the set
     ...
     *     set will not renew.
     * @param RenewalModeDTO|null $renewalMode Whether the set is set to renew or expire at the end of the current
     *     period
     */
    public function __construct(
        ...
        public ?RenewalModeDTO $renewalMode = null,
    ) {
    }
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            renewalMode: isset($data['renewal_mode']) ? RenewalModeDTO::from($data['renewal_mode']) : null,
        );
    }
