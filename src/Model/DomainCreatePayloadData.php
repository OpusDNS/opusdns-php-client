...
final readonly class DomainCreatePayloadData implements ApiModel
{
    /**
     ...
     * @param string|null $authCode The auth code used for the domain
     * @param string|null $claimsNoticeAcceptanceHash During the claims phase domain names that match a trademark
     *     registered in the Trademark Clearinghouse require an acceptance by the registrant.
