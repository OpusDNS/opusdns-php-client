...
{
    /**
     * @param VanityNsCheckConfidence $confidence How authoritative the observation is
     ...
     * @param VanityNsCheckSeverity $severity How much this check matters to the overall verdict
     * @param VanityNsCheckSource $source Where the observation came from
     * @param VanityNsCheckStatus $status Per-check verdict
    ...
    public function __construct(
        public VanityNsCheckConfidence $confidence,
        public string $detail,
        public string $id,
        public string $label,
        public VanityNsCheckSeverity $severity,
        public VanityNsCheckSource $source,
        public VanityNsCheckStatus $status,
    ...
    {
        return new self(
            confidence: VanityNsCheckConfidence::from($data['confidence']),
            detail: $data['detail'],
            id: $data['id'],
            label: $data['label'],
