 ...
 */
final readonly class ContextPayloadRegistrarContact implements ApiModel
{
    /**
     * @param list<RegistrarContact> $results
     */
    ...
    {
        return new self(
            results: array_map(static fn (array $item): RegistrarContact => RegistrarContact::fromArray($item), $data['results']),
