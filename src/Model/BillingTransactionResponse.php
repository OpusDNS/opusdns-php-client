...
{
    /**
     * @param BillingTransactionAction $action The action performed in the transaction
     ...
     * @param BillingTransactionProductType $productType The type of product
     ...
     * @param Currency|null $currency The currency of the transaction
     * @param string|null $productReference The reference of the product
     * @param BillingTransactionStatus $status The status of the transaction
    ...
    public function __construct(
        public BillingTransactionAction $action,
        public string $amount,
        public string $price,
        public BillingTransactionProductType $productType,
        ...
        public BillingTransactionStatus $status = BillingTransactionStatus::PENDING,
    ...
    {
        return new self(
            action: BillingTransactionAction::from($data['action']),
            amount: $data['amount'],
            price: $data['price'],
            productType: BillingTransactionProductType::from($data['product_type']),
            ...
            status: isset($data['status']) ? BillingTransactionStatus::from($data['status']) : BillingTransactionStatus::PENDING,
            unit: $data['unit'] ?? null,
