...
final readonly class WhitelabelBrandingResponse implements ApiModel
{
     ...
     * @param WhitelabelOnboardingStatus $onboardingStatus Onboarding lifecycle state
     * @param string $organizationId TypeID prefix: organization.
     * @param WhitelabelBrandingTier $tier Tier this config is on: base (managed subdomain) or plus (customer's own
     *     domain)
     ...
     * @param WhitelabelOnboardingFailureCode|null $failureCode Stable code of the last terminal onboarding failure
    ...
    public function __construct(
        ...
        public WhitelabelOnboardingStatus $onboardingStatus,
        public string $organizationId,
        public WhitelabelBrandingTier $tier,
        ...
        public ?WhitelabelOnboardingFailureCode $failureCode = null,
        public ?string $failureDetail = null,
        public ?WhitelabelOnboardingFailureType $failureType = null,
    ...
    public static function fromArray(array $data): static
    {
        return new self(
            ...
            onboardingStatus: WhitelabelOnboardingStatus::from($data['onboarding_status']),
            organizationId: $data['organization_id'],
            tier: WhitelabelBrandingTier::from($data['tier']),
            ...
            failureCode: isset($data['failure_code']) ? WhitelabelOnboardingFailureCode::from($data['failure_code']) : null,
            failureDetail: $data['failure_detail'] ?? null,
            failureType: isset($data['failure_type']) ? WhitelabelOnboardingFailureType::from($data['failure_type']) : null,
