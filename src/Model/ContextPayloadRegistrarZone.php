 ...
 */
final readonly class ContextPayloadRegistrarZone implements ApiModel
{
    /**
     * @param list<RegistrarZone> $results
     */
    ...
    {
        return new self(
            results: array_map(static fn (array $item): RegistrarZone => RegistrarZone::fromArray($item), $data['results']),
