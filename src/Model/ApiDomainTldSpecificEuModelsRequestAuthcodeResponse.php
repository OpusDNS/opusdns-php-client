 ...
 */
final readonly class ApiDomainTldSpecificEuModelsRequestAuthcodeResponse implements ApiModel
{
    /**
     * @param string $name The domain name that had the auth code requested
     * @param bool $success Whether the request had a successful result from EURid
     * @param string|null $authCode The auth code returned by EURid
