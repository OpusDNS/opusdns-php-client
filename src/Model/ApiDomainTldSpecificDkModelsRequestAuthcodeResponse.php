 ...
 */
final readonly class ApiDomainTldSpecificDkModelsRequestAuthcodeResponse implements ApiModel
{
    /**
     * @param string $name The domain name that had the auth code requested
     * @param bool $success Whether the request had a successful result from Punktum dk
     * @param string|null $authCode The auth code returned by Punktum dk
